...
- Let's flip a coin $n$ times, take the sample proportion of heads, subtract off .5 and multiply the result by
...
```{r eval=FALSE, fig.align='center', fig.height=6, fig.width=6, include=FALSE}
