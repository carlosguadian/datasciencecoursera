...
```{r galton, fig.height=6,fig.width=12, fig.align='center', message =FALSE, warning=FALSE}
...
```{r lsm, dependson="galton",fig.height=7,fig.width=7, fig.align='center'}
    g <- ggplot(galton, aes(x = child))
    g <- g + geom_histogram(fill = "salmon", 
      binwidth=1, aes(y = ..density..), colour = "black")
    g <- g + geom_density(size = 2)
...
```{r, fig.align='center', echo=TRUE, fig.height=4, fig.width=10}
...
```{r, fig.height=6, fig.width=6, echo=TRUE, fig.align='center'}
...
```{r, fig.height=6, figh.width=6, fig.align='center', echo = TRUE}
library(ggplot2)
nosim <- 10000; n <- 10
dat <- data.frame(
...
```{r, fig.align='center',fig.height=5, fig.width=10, echo = TRUE, warning=FALSE, error=FALSE, message=FALSE}  
dat <- data.frame(
